  ...
  return (
    ...
    >
      <Image
        ...
        height={150}
        alt="recipe-photo"
        className="title text-yellow-main mb-2 pb-2  w-fit relative overflow-visible bg-underline bg-no-repeat bg-[length:0_5px] bg-[0_100%] transition-all origin-left"
      />
